 ...
 */
public class AisinoPlatformJRLogsAsyncHbaseEventSerializer implements
		...
		if (payloadColumn != null) {
			...
			try {
				...
				case CUSTOMHASH:
					...
					rowKey = AisinoRowKeyUtil.getAisinoJRLogsRowKey(rowSuffix,
							payloadvalue);
					System.out
	...
	public void setEvent(Event event) {
		...
		String strBody=AisinoRowKeyUtil.getStrBody(strbody);
